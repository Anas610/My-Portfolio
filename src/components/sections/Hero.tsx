  ...
  return (
    <header id="home" className="section pt-20 md:pt-24 lg:pt-28">
      <div className="flex flex-wrap justify-between">
        <div className="mx-auto w-full max-sm:px-2 max-w-132 pt-8 sm:w-88 md:w-96 md:pt-12 lg:w-[27.2rem] lg:pt-20 xl:w-152 xl:pt-28">
          <p className="text-[1.41rem] font-semibold capitalize leading-normal">
            {personal.greeting}
          </p>
          <h1 className="my-2 text-[3rem] font-black capitalize tracking-[0.2rem] text-(--primary-color)">
            {personal.name}
          </h1>
          <p className="text-[1.41rem] font-semibold capitalize leading-normal">
            {personal.title}
        ...
        <div
          className="hero-blob mx-auto mt-8 overflow-hidden bg-cover bg-no-repeat max-sm:mt-8 max-sm:w-[90%] sm:mt-0 sm:h-auto sm:w-84 md:w-[22.6rem] lg:w-102"
          style={{
